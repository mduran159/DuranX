...
namespace catalog.api.Products.UpdateProduct
{
    ...
    internal class UpdateProductHandler(IDocumentSession session, ILogger<UpdateProductHandler> logger) : ICommandHandler<UpdateProdctCommand, UpdateProductResult>
    {
